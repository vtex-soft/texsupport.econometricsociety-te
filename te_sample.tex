...
\documentclass[te,nameyear,draft]{econsocart}
%
%\usepackage{}
...
This is the body of Theorem \ref{th1}. Theorem \ref{th1} is not numbered after Axiom \ref{ax1} or  Claim \ref{cl1}, because we didn't use \verb|[axiom]| in \verb|\newtheorem|, thus numbering starts from 1.
\end{theorem}
